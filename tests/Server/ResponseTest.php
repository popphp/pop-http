...
class ResponseTest extends TestCase
{
    ...
    public function testConstructor()
    {
        ...
        $this->assertEquals('text/plain', $response->getHeaderObject('Content-Type')->getValue(0));
    }
    ...
    public function testParseString1()
    {
        ...
        $this->assertEquals('text/html', $response->getHeaderObject('Content-Type')->getValue(0));
        $this->assertEquals('text/html', $response->getHeaderObjects()['Content-Type']->getValue(0));
